...
REGISTERSET(AhciPort,
	    REGISTER_RW("PxCLB",    0x0, 4, 0, 0xfffffc00),
	    REGISTER_RO("PxCLBU",   0x4, 4, 0),
	    REGISTER_RW("PxFB",     0x8, 4, 0, 0xffffff00),
	    REGISTER_RO("PxFBU",    0xc, 4, 0),
	    REGISTER   ("PxIS",    0x10, 4, 0, 0xdfc000af, 0, 0xdfc000af, AhciPort::CALLBACK_IS),
	    REGISTER_RW("PxIE",    0x14, 4, 0, 0x7dc0007f),
	    REGISTER   ("PxCMD",   0x18, 4, 0, 0xf3000011, 0, 0, AhciPort::CALLBACK_CMD),
	    REGISTER_PR("PxTFD",   0x20, 4, 0x7f),
	    REGISTER_PR("PxSIG",   0x24, 4, 0xffffffff),
	    REGISTER_PR("PxSSTS",  0x28, 4, 0),
	    REGISTER   ("PxSCTL",  0x2c, 4, 0, 0x00000fff, 0, 0, AhciPort::CALLBACK_SCTL),
	    REGISTER   ("PxSERR",  0x30, 4, 0, 0xffffffff, 0, 0xffffffff, 0),
	    REGISTER   ("PxSACT",  0x34, 4, 0, 0xffffffff, 0xffffffff, 0, 0),
	    REGISTER   ("PxCI",    0x38, 4, 0, 0xffffffff, 0xffffffff, 0, AhciPort::CALLBACK_CI),
	    REGISTER_RO("PxSNTF",  0x3c, 4, 0),
	    REGISTER_RO("PxFBS",   0x40, 4, 0));
...
REGISTERSET(AhciController,
	    REGISTER_PR("CAP",   0x0, 4, 0x40149f00 | (AhciController::MAX_PORTS - 1)),
	    REGISTER   ("GHC",   0x4, 4, 0x80000000, 0x3, 0x1, 0, AhciController::CALLBACK_GHC),
	    REGISTER   ("IS",    0x8, 4, 0, 0xffffffff, 0x00000000, 0xffffffff, 0),
	    REGISTER_PR("PI",    0xc, 4, 1),
	    REGISTER_RO("VS",   0x10, 4, 0x00010200),
	    REGISTER_RO("CAP2", 0x24, 4, 0x0));
