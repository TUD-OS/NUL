...
DEFAULT_PARAM(S0_DEFAULT,   "an alias for the default sigma0 parameters", "ioio hostacpi hostrtc pcicfg mmconfig atare hostreboot:0 hostreboot:1 hostreboot:2 hostreboot:3")
unsigned _ncpu=1;
